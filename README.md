...
## In calculator app there are 2 pages – HOME page and SETTINGS page

### Home page

![Screenshot Home page](https://github.com/upMyCode/calculator-app/blob/main/src/assets/img/home-page.png)

### Settings page

![Screenshot Settings page](https://github.com/upMyCode/calculator-app/blob/main/src/assets/img/settings-page.png)

## The main functionality in app this is make calculation. All operations add to left side History block

![Screenshot execute calculation functionality](https://github.com/upMyCode/calculator-app/blob/main/src/assets/img/calculation.png)

## The History can be hidden after click by History or appear after click to the button

![Screenshot hiding History](https://github.com/upMyCode/calculator-app/blob/main/src/assets/img/hidden-history.png)
